...
export const ISSUERS: Issuer[] = [
  ...
  { key: '신한', label: '신한카드·신한SOL페이', re: /신한|SOL ?페이|쏠페이/i },
  ...
  { key: 'IBK', label: 'IBK기업은행(나라사랑)', re: /\bIBK\b|기업은행/i },
  { key: '카카오페이', label: '카카오페이', re: /카카오 ?페이/ },
  { key: '네이버페이', label: '네이버페이', re: /네이버 ?페이/ },
  { key: 'PAYCO', label: 'PAYCO', re: /payco|페이코/i },
  { key: '토스', label: '토스', re: /토스 ?페이|토스 ?결제/i },
  { key: 'L.POINT', label: 'L.POINT(엘포인트)', re: /엘포인트|L\.? ?POINT/i },
  { key: 'OK캐쉬백', label: 'OK캐쉬백', re: /OK ?캐[쉬시]백/i },
];
